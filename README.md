...
直接复制 `modified-files/` 目录下的文件到对应位置：
- `modified-files/api.js` → `pikiclaw/dist/channels/weixin/api.js`
- `modified-files/channel.js` → `pikiclaw/dist/channels/weixin/channel.js`
- `modified-files/bot.js` → `pikiclaw/dist/channels/weixin/bot.js`
...
- [Pikiclaw 官方仓库](https://github.com/pikiclaw/pikiclaw)
- [微信 iLink API 文档](https://ilinkai.weixin.qq.com)
